## Introduction ##
- This 'proof of concept' is designed to override the default behavior of the 'PublishingPanelCategory' to control when the Publishing menu item is shown in the Site Administration Menu.
...
- If additional roles (Regular or Site etc.) should also see the Publishing category then the code in CustomPublishingPanelCategory isShow method should be updated to include additional role check(s).
